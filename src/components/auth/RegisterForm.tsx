  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription>Wypełnij formularz, aby zarejestrować nowe konto</CardDescription>
      </CardHeader>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-10 ${touchedFields.confirmPassword && !errors.confirmPassword && watch("confirmPassword") && watchedPassword === watch("confirmPassword") ? "border-green-500 dark:border-green-600" : ""}`}
                autoComplete="new-password"
              />
            </div>
